...
const variables = require("./tools/variables.js");
const removeDoubledSolidityVersion = require("./tools/remove-doubled-solidity-version.js");
const replaceAllImportsRecursively = require("./tools/replace-all-imports-recursively.js");
const addLibraries = require("./tools/add-libraries.js"); 
